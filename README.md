...
#let convert(cont) = {
  ...
  // i gotta say it's really weird that,in input string will become \\ in var(hold the mouse on the var then you can see it becomes \\), and if you want to capture it in regex, you have to use \\\\. But when showed on the paper \\ in var turns back to \
